...
class ResPartner(models.Model):
    ...
    woo_address_bind_ids = fields.One2many(
        ...
        inverse_name='openerp_id',
        string="WooCommerce Address Bindings",
    )
...
class MagentoResPartner(models.Model):
    ...
    website_id = fields.Many2one(comodel_name='woo.website',
                                 string='WooCommerce Website',
                                 required=True,
                                 ondelete='restrict')
    group_id = fields.Many2one(comodel_name='woo.res.partner.category',
                               string='WooCommerce Group (Category)')
